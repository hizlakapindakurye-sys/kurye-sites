  ...
  return (
    <div className="bg-white py-16 relative">
      ...
      <div className="hidden md:flex fixed left-6 top-1/2 transform -translate-y-1/2 z-40">
        <a href="https://wa.me/905452145949" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-green-700 text-white rounded-full shadow-2xl hover:scale-110 transform transition-all" aria-label="WhatsApp ile bize yazın">
