  ...
  return (
    <div className="bg-white py-16 relative">
      ...
      <div className="hidden md:flex fixed left-6 top-1/2 transform -translate-y-1/2 z-40">
        <a
          href="https://wa.me/905452145949"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-green-700 text-white rounded-full shadow-2xl hover:scale-110 transform transition-all"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-700 text-center mb-3">
              Hızla Kapında Kurye olarak, İstanbul'un tüm bölgelerinde hızlı,
              güvenilir ve ekonomik kurye hizmetleri sunuyoruz.
            </p>
            <p className="text-base text-gray-600 text-center">
              Aşağıdaki formu doldurarak anında WhatsApp üzerinden fiyat teklifi
              alabilir veya{" "}
              <strong className="text-blue-700">0545 214 59 49</strong>{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
            <div className="bg-blue-50 border-l-4 border-yellow-400 p-4 rounded">
              <div className="flex items-start gap-3">
                <svg
                  className="w-7 h-7 text-yellow-500 flex-shrink-0 mt-0.5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Motorlu ve arabalı kurye seçenekleri ile hızlı teslimat
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-blue-50 border-l-4 border-yellow-400 p-4 rounded">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Tüm gönderileriniz korunmalı ve güvenli
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-blue-50 border-l-4 border-yellow-400 p-4 rounded">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    Rekabetçi fiyatlar ve uygun teklifler
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <details className="bg-gray-50 p-4 rounded cursor-pointer hover:bg-gray-100 transition">
                ...
                <p className="text-gray-700 mt-2">
                  Evet, acil teslimatlar için VIP hizmetimizi kullanabilirsiniz.
                  WhatsApp üzerinden anında teklif alabilirsiniz.
                </p>
              </details>
              <details className="bg-gray-50 p-4 rounded cursor-pointer hover:bg-gray-100 transition">
                <summary className="font-semibold text-gray-800 flex items-center gap-2">
                ...
                <p className="text-gray-700 mt-2">
                  Evet, arabalı kurye hizmeti ile büyük ve ağır paketler güvenle
                  gönderilebilir. Detaylar için bize ulaşın.
                </p>
              </details>
              <details className="bg-gray-50 p-4 rounded cursor-pointer hover:bg-gray-100 transition">
                <summary className="font-semibold text-gray-800 flex items-center gap-2">
                ...
                <p className="text-gray-700 mt-2">
                  24/7 hizmet sunuyoruz. Her saat başında WhatsApp üzerinden
                  talep alabilirsiniz.
                </p>
              </details>
            </div>
...
function ContactForm() {
  const [pickupSide, setPickupSide] = React.useState<"avrupa" | "anadolu">(
    "avrupa",
  );
  const [deliverySide, setDeliverySide] = React.useState<"avrupa" | "anadolu">(
    "avrupa",
  );
  const pickupDistrictOptions =
    pickupSide === "avrupa" ? districts.avrupa : districts.anadolu;
  const deliveryDistrictOptions =
    deliverySide === "avrupa" ? districts.avrupa : districts.anadolu;
...
*Notlar:* ${note || "-"}`;
          ...
          const whatsappUrl = `https://wa.me/905452145949?text=${encodeURIComponent(message)}`;
      ...
      >
        ...
        <div>
          ...
          <p className="text-center text-sm text-gray-600 mt-2">
            Butona Basıldığında WhatsApp Açılır.
          </p>
        </div>
      </form>
    </div>
