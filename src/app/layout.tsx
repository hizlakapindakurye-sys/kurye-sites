...
export const metadata: Metadata = {
  ...
  description:
    "İstanbul içi tüm ilçelere hızlı, güvenilir ve uygun fiyatlı motorlu kurye hizmetleri. Acil gönderileriniz için bize ulaşın.",
  ...
  return (
    <html lang="tr">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-18087763288"
        ></script>
        <script
